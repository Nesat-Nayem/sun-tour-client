  ...
  return (
    <Container id='contact' sx={{ my: 8 }}>
      <Grid container rowSpacing={3} columnSpacing={8}>
        ...
        <Grid item md={6}>
          <img className='contractImg' style={{ width: "100%" }} src="https://i.ibb.co/yXfYXgW/Young-business-woman-working-at-the-computer-in-cafe-on-the-rock-Young-girl-downshifter-working-at-a.jpg" alt="" />
        </Grid>
      </Grid>
    </Container>
  );
