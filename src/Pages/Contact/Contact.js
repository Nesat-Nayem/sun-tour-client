      ...
      <Grid container rowSpacing={3} columnSpacing={8}>
        <Grid item md={6} sx={{ margin: "auto" }}>
          ...
          <form style={{ width: "100%" }}>
            <TextField fullWidth label="Name" id="fullWidth" sx={{ my: 1 }} />
            <TextField fullWidth label="Email" id="fullWidth" sx={{ my: 1 }} />
            <TextField
              fullWidth
              label="Subject"
              id="fullWidth"
        ...
        <Grid item md={6}>
          <img
            ...
            style={{ width: "100%" }}
            src="https://i.ibb.co/yXfYXgW/Young-business-woman-working-at-the-computer-in-cafe-on-the-rock-Young-girl-downshifter-working-at-a.jpg"
            alt=""
          />
        </Grid>
      </Grid>
